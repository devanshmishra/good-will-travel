                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        ...
                                                        <div class="weather-icon">
                                                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/weather-icon-03.png" alt="">
                                                        </div>
                                                        <span>32&deg;C</span>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        <h6>Thailand</h6>
                                                        <div class="weather-icon">
                                                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/weather-icon-02.png" alt="">
                                                        </div>
                                                        <span>28&deg;C</span>
                                                        <ul class="time-weather">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        <h6>India</h6>
                                                        <div class="weather-icon">
                                                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/weather-icon-01.png" alt="">
                                                        </div>
                                                        <span>33&deg;C</span>
                                                        <ul class="time-weather">
                                                            <li>6AM <span>26&deg;</span></li>
