...
OpenWeatherMap retrieves the weather information from the [Open Weather Map](https://openweathermap.org/) website, a free and paid Weather Data and Forecast API provider. So you will need to have an account & API key to use it to avoid running into call limits. [__Get your free 
Own API key!__](https://home.openweathermap.org/api_keys)
...
Get a Free Open Weather Map API key to access the Weather Data of your
Location.
...
* 4 Exclusive Weather Layouts **(Vertical Card, Horizontal, Tabs, and Table)**
...
* Auto Detect Visitor Location via IP address **(Pro)**
...
* Set Weather-based Backgrounds or Images (Sunny, Cloudy, Drizzly, Rainy, Snowy, Stormy, and Foggy) **(Pro)**
...
* [__Browse 30+ Live Website Showcases__](https://locationweather.io/showcase/)
