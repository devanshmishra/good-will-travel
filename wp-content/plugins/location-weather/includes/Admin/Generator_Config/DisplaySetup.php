	...
	array(
		...
		'fields' => array(
			array(
				...
				'tabs'  => array(
					array(
						'title'  => __( 'General', 'location-weather' ),
						'fields' => array(
							array(
								'id'         => 'lw-title',
								'type'       => 'switcher',
					...
					array(
						'title'  => __( 'Additional Data Style', 'location-weather' ),
						'fields' => array(
							array(
							...
							array(
								...
								'type'       => 'checkbox',
								'title'      => __( 'Comport Data Position', 'location-weather-pro' ),
								'default'    => false,
					...
					array(
						...
						'fields' => array(
							array(
								...
								'content' => 'The following advanced <strong class="lw-bold-text">Weather Forecast Data</strong> options are premium features. To unlock, <a class="lw-open-live-demo" href="https://locationweather.io/pricing/?ref=1" target="_blank"><strong>Upgrade To Pro!</strong></a>',
							),
							array(
							...
							array(
								...
								'min'        => 1,
								'default'    => 320,
								'title_info' => '<div class="lw-img-tag"><img src="' . SPLW::include_plugin_url( 'assets/images/forecast-area-maximum-height.svg' ) . '" alt="forecast-area-maximum-height"></div><div class="lw-info-label img">' . __( 'Forecast Area Maximum Height', 'location-weather-pro' ) . '</div>',
								'dependency' => array( 'lw-enable-forecast', '==', 'true', true ),
							),
							array(
