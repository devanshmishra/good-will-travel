...
if ( count( $shortcode_ids ) > 0 ) {
	foreach ( $shortcode_ids as $shortcode_id ) {
		...
		$splw_shortcode_meta['lw-weather-additional-data-margin']['top']      = $splw_shortcode_meta['lw-weather-units-typography']['margin-top'];
		$splw_shortcode_meta['lw-weather-additional-data-margin']['bottom']   = $splw_shortcode_meta['lw-weather-units-typography']['margin-top'];
		$splw_shortcode_meta['lw-attr-margin']['top']                         = $splw_shortcode_meta['lw-weather-attr-typography']['margin-top'];
		$splw_shortcode_meta['lw-attr-margin']['bottom']                      = $splw_shortcode_meta['lw-weather-attr-typography']['margin-bottom'];
